...
function ModalWrapper({ setShowModal, children, customClass }: PropType) {
  return (
    <>
      <div className={`absolute font-roboto overflow-auto left-1/2 -translate-x-1/2 z-[50] items-center flex -translate-y-1/2 bg-white max-w-[44em] w-full min-h-[20em] rounded-lg flex-col gap-7 ${customClass}`}>
        <button
