...
export const meta: MetaFunction<typeof loader> = ({ data }) => {
  ...
  const desc = count
    ? `Browse ${count.toLocaleString()} curated ${LENGTH}-letter words for word games like Wordle, crosswords, anagrams, and cryptograms. Perfect for practice, puzzles, and vocabulary building.`
