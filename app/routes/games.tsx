...
export const meta: MetaFunction = ({ matches }) => {
  ...
  const title =
    "Play Word Games | Word Skull — Classic Modes & More Coming Soon";
  const description =
    "Explore Word Skull games. Start with Classic modes (Easy, Medium, Hard, Royal Lichen) and get ready for new word challenges rolling out soon.";
