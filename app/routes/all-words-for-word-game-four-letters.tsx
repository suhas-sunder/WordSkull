...
export const meta: MetaFunction = () => {
  return [
    {
      title:
        "Words List - Four letter words used for word and Puzzle Games 🎉✨",
    },
    {
      name: "description",
      content:
        "List of Four letter words in WordSkull the ultimate word game inspired by word & puzzle games like Wordle, crosswords, cryptogram... 🎉📲",
    },
  ];
};
      ...
      <main className="flex max-w-[1200px] flex-col w-full">
        ...
        >
          <h2 className="text-2xl">
            There are{" "}
            {wordsData && (Object.values(wordsData) as string[][])[1].length}{" "}
            words in this list!
          </h2>
          <p className="grid grid-cols-16 gap-5">
            {wordsData &&
              (Object.values(wordsData) as string[][])[1]?.map((word) => (
