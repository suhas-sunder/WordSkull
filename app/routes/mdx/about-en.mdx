...
<div className="flex flex-row gap-3 items-center text-base mb-5 sm:mb-4 px-3">
  <picture>
    <source
  ...
  {/* prettier-ignore */}
  <p className="pl-2">By [Suhas Sunder](https://github.com/suhas-sunder), Professional Software Developer - {`November ${1}, ${2024}`}</p>
</div>
