...
<div className="flex flex-col sm:flex-row gap-3 items-center text-center sm:text-left text-base mb-8 sm:mb-7 mt-2 px-3">
  <picture>
    <source
      srcSet={
        "https://www.honeycombartist.com/word-skull/img/article-default-profile-pic.webp"
      }
      type="image/webp"
    />
    <source
      srcSet={
        "https://www.honeycombartist.com/word-skull/img/article-default-profile-pic.jpg"
      }
      type="image/jpeg"
    />
    <img
      ...
      className="flex w-full max-w-[5em] sm:max-w-[3em] rounded-full overflow-hidden"
      width={40}
      height={40}
    />
  </picture>
  {/* prettier-ignore */}
  <p className="pl-2">By [Suhas Sunder](https://github.com/suhas-sunder), Professional Software Developer - {`November ${30}, ${2024}`}</p>
</div>

<figure className="mb-3 px-3">
  <picture className="flex rounded-xl overflow-hidden shadow-sm shadow-stone-100">
    <source
      srcSet={
        "https://www.honeycombartist.com/word-skull/img/about-pg-header-img.webp"
      }
      type="image/webp"
    />
    <source
      srcSet={
        "https://www.honeycombartist.com/word-skull/img/about-pg-header-img.jpg"
      }
      type="image/jpeg"
    />
    <img
      ...
      alt="WordSkull classic word game board and keyboard"
      width={876}
      height={317}
    />
  </picture>
