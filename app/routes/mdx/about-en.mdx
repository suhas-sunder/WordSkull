...
<div className="flex flex-col sm:flex-row gap-3 items-center text-center sm:text-left text-base mb-8 sm:mb-7 mt-2 px-3">
  <picture>
    <source
      srcSet={
        "https://www.doodlegarden.com/img/article-default-profile-pic.webp"
      }
      type="image/webp"
    />
    <source
      srcSet={
        "https://www.doodlegarden.com/img/article-default-profile-pic.jpg"
      }
      type="image/jpeg"
    />
    <img
...
<figure className="mb-3 px-3">
  <picture className="flex rounded-xl overflow-hidden shadow-sm shadow-stone-100">
    <source
      srcSet={
        "https://www.doodlegarden.com/img/about-pg-header-img.webp"
      }
      type="image/webp"
    />
    <source
      srcSet={
        "https://www.doodlegarden.com/img/about-pg-header-img.jpg"
      }
      type="image/jpeg"
    />
    <img
