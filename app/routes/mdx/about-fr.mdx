...
<figure className="mb-3 px-3">
  <picture>
    <source srcSet={"https://www.honeycombartist.com/word-skull/img/dance.jpg"} type="image/webp" />
    <source srcSet={"https://www.honeycombartist.com/word-skull/img/dance.jpg"} type="image/jpeg" />
    <img
...
<figure className="mb-3 px-3">
  <picture>
    {/* <source srcSet={"https://www.honeycombartist.com/word-skull/img/dance.jpg"WebP} type="image/webp" />
              <source srcSet={"https://www.honeycombartist.com/word-skull/img/dance.jpg"Jpg} type="image/jpeg" /> */}
    <img
      className="flex w-full"
      src={"https://www.honeycombartist.com/word-skull/img/dance.jpg"}
      alt="Description of the article"
...
Aside from word games and puzzles, WordSkull also offers high quality 4K HD wallpapers for free! You can download the [wallpapers](/wallpaper) here.
