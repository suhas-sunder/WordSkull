      ...
      >
        <div className="flex flex-col flex-wrap justify-center gap-8 max-w-[1200px] items-center w-full ">
          <div className="flex flex-col justify-center items-center gap-1">
            <h3 className="font-lora text-2xl text-skull-super-dark-brown">
              WordSkull Classic
            </h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 xl:grid-cols-8  gap-12 justify-center items-center">
            <button
              ...
              className="group flex col-span-2 flex-col gap-2 w-[15em] justify-center items-center text-center pt-8 pb-12  hover:scale-[1.05] transition-scale duration-[300ms] shadow-md rounded-t-[150em] rounded-b-full bg-ivory"
            >
              <h4 className="text-lg font-nunito">Bonehead</h4>
              <img
                src={WordSkullClassicEasy}
                alt="Word Skull Classic"
                className="bg-black w-[180px] h-[180px] rounded-lg"
              />
              <h5 className="text-base font-nunito">Difficulty: Easy</h5>
            ...
            <button
              ...
              className="group flex col-span-2 flex-col gap-2 w-[15em] justify-center items-center text-center pt-8 pb-12  hover:scale-[1.05] transition-scale duration-[300ms] shadow-md rounded-t-[150em] rounded-b-full bg-ivory"
            >
              <h4 className="text-lg font-nunito">Specter</h4>
              <img
                src={WordSkullClassicEasy}
                alt="Word Skull Classic"
                className="bg-black w-[180px] h-[180px] rounded-lg"
              />
              <h5 className="text-base font-nunito">Difficulty: Medium</h5>
            ...
            <button
              ...
              className="group flex col-span-2 flex-col gap-2 w-[15em] justify-center items-center text-center pt-8 pb-12  hover:scale-[1.05] transition-scale duration-[300ms] shadow-md rounded-t-[150em] rounded-b-full bg-ivory"
            >
              <h4 className="text-lg font-nunito">Reaper</h4>
              <img
                src={WordSkullClassicEasy}
                alt="Word Skull Classic"
                className="bg-black w-[180px] h-[180px] rounded-lg"
              />
              <h5 className="text-base font-nunito">Difficulty: Hard</h5>
            ...
            <button
              ...
              className="group flex col-span-2 flex-col gap-2 w-[15em] justify-center items-center text-center pt-8 pb-12  hover:scale-[1.05] transition-scale duration-[300ms] shadow-md rounded-t-[150em] rounded-b-full bg-ivory"
            >
              <h4 className="text-lg font-nunito">Lich King</h4>
              <img
                src={WordSkullClassicEasy}
                alt="Word Skull Classic"
                className="bg-black w-[180px] h-[180px] rounded-lg"
              />
              <h5 className="text-base font-nunito">Difficulty: Extreme</h5>
          ...
          <ul className="text-skull-dark-brown flex flex-col gap-4">
            <li className="flex flex-col gap-2">
              ...
              <p className="font-lato text-lg pl-5 tracking-wider leading-loose">
                ...
                challenges. Play the best free online word and puzzle games with
                a twist on popular classics. Enjoy games inspired by Wordle,
                word search, math puzzles, cryptograms, and more. The classic
                mode feels a lot like Wordle but more of a challenges as you
                solve for multiple words instead of just one. The goal is to
                guess the correct words in as few tries as possible. More game
                modes are on the way to mix things up and word it out!
              </p>
            </li>
            <li className="flex flex-col gap-2">
              <h3 className="flex py-2 text-xl font-nunito mt-2 text-skull-super-dark-brown">
