...
export const meta: MetaFunction = ({ matches }) => {
  ...
  const title =
    "Classic Word Games | Word Skull — Boneheads, Specter, Reapers & Royal Lichen";
  const description =
    "Play Classic Word Skull modes: Boneheads (Easy 3–5), Specter (Medium 3–6), Reapers (Hard 3–7), and Royal Lichen (Extreme 3–9). Fast, replayable word challenges.";
  ...
  if (isIndex) tags.push({ tagName: "link", rel: "canonical", href: url });
  return tags;
};
