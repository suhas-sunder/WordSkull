      ...
      <main className="flex max-w-[1200px] w-full mt-4 justify-center">
        <article className="flex flex-col max-w-[800px] mx-10">
          ...
          <p className="font-lato text-lg tracking-wider leading-loose pl-2 mb-3">
            ...
            is a fun and fast-paced word puzzle game where you can improve your
            vocabulary by solving word challenges, get better at math with
            number puzzles, and participate in other fun learning activities.
            The classic mode of WordSkull feels a lot like Wordle but is
            designed to be more of a challenge as you solve for multiple words
            instead of just one. The goal is to guess the correct words in as
            few tries as possible. More game modes are on the way to mix things
            up and word it out!
          </p>
          <h3
            className={`${
